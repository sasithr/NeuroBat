...
ENGINE_VERSION = "NeuroBat-Biomechanics-V3.2-ExtendedBiomechanics"
...
def process_video(
    ...
    """Run NeuroBat Biomechanics Engine V3.2 on one uploaded batting video."""
    ...
    average_knee_angle = round(
        (avg_left_knee_angle + avg_right_knee_angle) / 2.0, 1
    )
